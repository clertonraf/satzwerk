...
interface LeastTrainedExercisesCardProps {
  exercises: TopExercise[]
}

export default function LeastTrainedExercisesCard({ exercises }: LeastTrainedExercisesCardProps) {
  return (
    <Card>
      <CardHeader className="pb-2">
        <CardTitle className="text-sm">Least trained exercises</CardTitle>
      </CardHeader>
      <CardContent>
        {exercises.length === 0 ? (
